...
# This script operates on a directory, such as in data_list/train/,
...
#  text
#
# It generates the files which are used for perturbing the speed of the original data_list.
