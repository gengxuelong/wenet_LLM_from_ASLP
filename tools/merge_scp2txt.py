...
def get_parser():
    parser = argparse.ArgumentParser(
        ...
        'is "str". e.g. {} '
        '--input-scps feat:data_list/feats.scp shape:data_list/utt2feat_shape:shape '
        '--input-scps feat:data_list/feats2.scp shape:data_list/utt2feat2_shape:shape '
        '--output-scps text:data_list/text shape:data_list/utt2text_shape:shape '
        '--scps utt2spk:data_list/utt2spk'.format(sys.argv[0]),
