...
from wenet.ASRLLM.init_ASRLLM import init_ASLP_ASRLLM
...
def init_model(args, configs,is_inference=False):
    model_type = configs.get('model', 'asr_model')
    if model_type == "ASRLLM":
        model, configs = init_ASLP_ASRLLM(args, configs, is_inference)
